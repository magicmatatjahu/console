...
<DatePicker enableRangeSelection disablePastDates compact />`;
  ...
  return (
    <div>
      ...
      <Description>
        The date-picker component is an opinionated composition of the
        "input-group", "popover" and "calendar" components to accomplish the UI
        pattern for picking a date.
      </Description>
      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'buttonProps',
            description:
              'object - additional props to be spread to Calendar button',
          },
          {
            name: 'inputProps',
            description:
              'object - additional props to be spread to text input field',
          },
        ]}
        type="Inputs"
      />
      ...
      <DocsTile centered>
        <div className="fd-doc__margin--datePicker">
          <DatePicker
            disableBeforeDate={new Date(2018, 11, 24, 0, 0, 0, 0)}
            disableWeekends
          />
          <DatePicker
            blockedDates={[
              new Date(2018, 11, 1, 0, 0, 0, 0),
              new Date(2018, 11, 23, 0, 0, 0, 0),
            ]}
            compact
            disableWeekday={['Monday', 'Tuesday']}
          />
