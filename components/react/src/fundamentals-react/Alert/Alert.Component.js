...
export const AlertComponent = () => {
  const defaultAlertCode =
    '<Alert dismissible link="#" linkText="link">Default alert with a </Alert>';
  ...
  return (
    <div>
      <Header>Alert</Header>
      <Description>
        Alerts provide messages within the application that are color-coded to
        emphasize the level of urgency.
      </Description>
      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'dismissible',
            description:
              'bool - Shows a dismissible button if set to true. Default is false.',
          },
          {
            name: 'buttonProps',
            description:
              "object - additional props to be spread to the Alert component's button element.",
          },
          {
            name: 'linkProps',
            description:
              "object - additional props to be spread to the Alert component's anchor element.",
          },
        ]}
        type="Inputs"
      />
      ...
      <h2>Default Alert</h2>
      <Description>
        The alert provides information that is useful and relevant, but not
        critical. It can also provide feedback that an action has been executed.
        The user will need to dismiss the message.
      </Description>
      <DocsTile>
      ...
      <h2>Warning Alert</h2>
      <Description>
        The alert warns of potential issues, but the user can still continue.
        The user will need to dismiss the message. Apply type="warning".
      </Description>
      <DocsTile>
      ...
      <h2>Error Alert</h2>
      <Description>
        This alert is triggered after the user entered data incorrectly or a
        system error has occurred. It should interrupt the user. A final action
        such as Submit cannot be carried out until the user has rectified the
        error. The user will need to dismiss the message. Apply type="error".
      </Description>
      <DocsTile>
      ...
      >
        <Alert dismissible={false} link="#" linkText="link" type="">
          Default alert with a{' '}
        </Alert>
      </Playground>
    </div>
