...
`;
  ...
  productSwitcherList = [
    ...
    },
    {
      ...
      image: images('./10.png'),
      glyph: 'area-chart',
      callback: () => alert('Concur selected!'),
    },
    {
      title: 'Cloud for Customer',
      image: images('./11.png'),
  ...
  render() {
    return (
      <div>
        ...
        <Description>
          The shellbar offers consistent, responsive navigation across all
          products and applications. Includes support for branding, product
          navigation, search, notifications, user settings, and CoPilot. This is
          a composite component comprised of mandatory and optional elements.
        ...
        <Properties
          properties={[
            ...
            },
            {
              name: 'productTitle',
              description:
                '(required) displays the current application when no product menu is used.',
            },
            {
              name: 'productMenu',
              description: '(optional) holds product titles and navigation.',
            },
            {
              name: 'subtitle',
              description:
                '(optional) displays an application context. Should be used rarely.',
            },
            {
              name: 'copilot',
              description:
                '(optional) for use with applications that utilize CoPilot.',
            },
            {
              name: 'actions',
              description: '(optional) holds all product actions and links.',
            },
            {
              name: 'searchInput',
              description:
                '(optional) holds searchInput properties (placeholder, searchList, onEnter ).',
            },
            {
              name: 'profile',
              description:
                '(required) user information like name, initials, etc.',
            },
            {
              name: 'profileMenu',
              description:
                '(required) for user settings and application meta links such as Sign Out.',
            },
            {
              name: 'productSwitcher',
              description: '(optional) for navigating between products.',
            },
            {
              name: 'productSwitcherList',
              description: '(optional) list of the products.',
            },
          ]}
          type="Inputs"
        />
        ...
        <Description>
          This example shows the minimum shellbar for a single application
          product with only user settings. If no user thumbnail is available
          then display initials.
        </Description>
        <DocsTile>
          <Shellbar
            logo={
        ...
        <Description>
          This example includes the product menu for navigating to applications
          within the product and shows a search box.
        </Description>
        <DocsTile>
          <Shellbar
            logoSAP
        ...
        <Description>
          When a product has multiple links, the product links should collapse
          into an overflow menu on mobile screens. All actions, except for the
          user menu, should be collapsed.
        </Description>
        <DocsTile>
          <Shellbar
            actions={this.actions}
