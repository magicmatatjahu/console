...
export class Shellbar extends Component {
  ...
  getNotificationsSum = () => {
    ...
    if (this.props.actions) {
      additionalActionsSum = this.props.actions.reduce(
        (r, d) => r + d.notificationCount,
        0,
      );
    }
    if (this.props.notifications) {
      if (this.props.notifications.notificationCount) {
        let totalSum =
          additionalActionsSum + this.props.notifications.notificationCount;
        return totalSum;
      } else {
  ...
  render() {
    ...
    const shellbarClasses = classnames('fd-shellbar', className);
      ...
      <div className={shellbarClasses}>
        <div className="fd-shellbar__group fd-shellbar__group--start">
          ...
          <div className="fd-shellbar__product">
            {productTitle &&
              !productMenu && (
                <span className="fd-shellbar__title">{productTitle}</span>
              )}
            {productMenu && (
                      ...
                      <Popover
                        ...
                        control={
                          <button
                            ...
                            className={` fd-button--shell sap-icon--${
                              action.glyph
                            }`}
                          >
              ...
              <div className="fd-shellbar__action fd-shellbar__action--collapsible">
                <div className="fd-product-switcher">
                  <Popover
                    ...
                    control={
                      <button className=" fd-button--shell sap-icon--grid" />
                    }
                  />
                </div>
              </div>
