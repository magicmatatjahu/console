...
export class MultiInput extends Component {
  ...
  render() {
    ...
    const multiInputClasses = classnames('fd-multi-input', className);
    ...
    const inputClassNames = classnames('fd-input', {
      'fd-input--compact': compact,
    });

    return (
      <div {...rest} className={multiInputClasses}>
        ...
        {this.state.tags.length > 0 ? (
          <div {...tagProps} className="fd-multi-input-tags">
            {this.createTags()}
          </div>
        ) : (
          ''
