...
<ButtonGroup>
  ...
  return (
    <div>
      ...
      <Description>
        The Buttons allow users to perform actions. The priority of buttons
        within a page should be considered. For instance, only use the main
        button once within a page or modal. Color is also important. For
        instance, the most important button has a blue background where as a red
        button should only be used if the action it performs is potentially
        destructive.
      </Description>
      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'onClick',
            description:
              'func - The function that is executed when the button is clicked.',
          },
        ]}
        type="Inputs"
      />
      ...
      <Description>
        There are three emphasis styles used to indicate the importance of the
        button on the page. <br />
        <strong>- Emphasized Button</strong>: There should only be one
        highlighted button on the page. This is the primary call to action.{' '}
        <br />
        <strong>- Regular Button</strong>: The default button style and the most
        common button. There may be more than one on a page. <br />
        <strong>- Light Button</strong>: This is the lowest priority button and
        most often used with page content like appearing in a table or list.
        There may be more than one on the page.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
          <Button
            onClick={() => clickBtnHandler('Emphasized')}
            option="emphasized"
          >
            Emphasized Button
          </Button>
          <Button onClick={() => clickBtnHandler('Regular')}>
            Regular Button
          </Button>
          <Button onClick={() => clickBtnHandler('Light')} option="light">
            Light Button
          </Button>
        </div>
      </DocsTile>
      ...
      <Description>
        ...
        <strong> - Positive Button</strong>: Used for positive actions such as
        approved, ok, yes. <br />
      ...
      <Description>
        Button can have an icon with text or just and icon. You can use{' '}
        <code> glyph="icon-name"</code> to attach an icon to the button.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
      ...
      <h2>Button Sizes</h2>
      <Description>
        There are two sizes. The <code>compact</code> size is only used on
        desktop and it is full size when used on a touch device.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
      ...
      <h2>Button States</h2>
      <Description>
        There are three states: <code>normal</code> (default),{' '}
        <code>selected</code>, and <code>disabled</code>.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
