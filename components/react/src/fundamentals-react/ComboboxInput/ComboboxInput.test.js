...
describe('<ComboboxInput />', () => {
  ...
  const defaultComboBoxInput = (
    <ComboboxInput menu={defaultMenu} placeholder="Select Fruit" />
  );
  ...
  describe('Prop spreading', () => {
    test('should allow props to be spread to the ComboboxInput component', () => {
      const element = mount(
        <ComboboxInput data-sample="Sample" menu={defaultMenu} />,
      );
    ...
    test("should allow props to be spread to the ComboboxInput component's Popover component", () => {
      ...
      expect(
        element.find('div.fd-popover').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the ComboboxInput component's button element", () => {
      ...
      expect(
        element.find('button.sap-icon--navigation-down-arrow').getDOMNode()
