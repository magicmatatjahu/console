...
export const SideNav = props => {
  ...
  const sideNavClasses = classnames('fd-side-nav', {
...
export class SideNavList extends Component {
  ...
  getLinkClasses = ({ id, hasChild }) => {
    return classnames('fd-side-nav__link', {
  ...
  getSubLinkClasses = id => {
    return classnames('fd-side-nav__sublink', {
      'is-selected': this.state.selectedItem === id,
    });
  };
  ...
  render() {
    ...
    const sideNavListClasses = classnames('fd-side-nav__list', className);

    return (
      <BrowserRouter>
        <ul {...rest} className={sideNavListClasses}>
          {items.map(item => {
            return (
...
export const SideNavGroup = props => {
  ...
  const sideNavGroupClasses = classnames('fd-side-nav__group', className);

  return (
    <div {...rest} className={sideNavGroupClasses}>
