...
export const SideNavigationComponent = () => {
  ...
  return (
    <div>
      ...
      <Description>
        The left navigation can always display or expand/collapse using the menu
        icon within the global navigation.
      </Description>
        ...
        properties={[
          {
            name: 'icons',
            description:
              "bool - when set to 'true' enables side navigation collapsed with icons.",
          },
          {
            name: 'items',
            description:
          ...
          { name: 'name', description: "string - the 'name' of the link." },
          {
            name: 'hasChild',
            description:
              "bool - when set to 'true' enables a second level of navigation.",
          },
          {
            name: 'child',
            description:
          ...
          },
          {
            name: 'glyph',
            description:
              'string - the name of the icon for navigation list with icons.',
          },
        ]}
        type="Inputs"
      />
      ...
      <Description>
        Use this when there is more than one level of hierarchy in the left
        navigation. Each level can be expanded and collapsed.
      </Description>
      <DocsTile>
        <SideNav>
          <SideNavList
      ...
      <Description>
        The user can identify which level they are on based on the icon
        displayed as selected when the navigation is collapsed. Note that the
        suggested use is when there is only one level of navigation as the user
        can only see one level of navigation when collapsed.
      </Description>
      <DocsTile>
        <SideNav icons>
          <SideNavList
