...
export const PanelGrid = props => {
  ...
  return (
    <div {...rest} className={panelGridClasses}>
      {children}
    </div>
  );
};
...
export const PanelBody = props => {
  ...
  const panelBodyClasses = classnames('fd-panel__body', className);

  return (
    <div {...rest} className={panelBodyClasses}>
      {children}
    </div>
  );
};
...
export const PanelHeader = props => {
  ...
  const panelHeaderClasses = classnames('fd-panel__header', className);

  return (
    <div {...rest} className={panelHeaderClasses}>
      {children}
    </div>
  );
};
...
export const PanelHead = props => {
  ...
  const panelHeadClasses = classnames('fd-panel__head', className);
...
export const PanelActions = props => {
  ...
  const panelActionsClasses = classnames('fd-panel__actions', className);

  return (
    <div {...rest} className={panelActionsClasses}>
      {children}
    </div>
  );
};
...
export const PanelFilters = props => {
  ...
  const panelFiltersClasses = classnames('fd-panel__filters', className);
...
export const PanelContent = props => {
  ...
  const panelContentClasses = classnames('fd-panel__content', className);

  return (
    <div {...rest} className={panelContentClasses}>
      {children}
    </div>
  );
};
...
export const PanelFooter = props => {
  ...
  const panelFooterClasses = classnames('fd-panel__footer', className);

  return (
    <div {...rest} className={panelFooterClasses}>
      {children}
    </div>
  );
};
