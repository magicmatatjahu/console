      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'cols',
            description:
              'number - The number of column grid. Used with <PanelGrid /> component.',
          },
          {
            name: 'colSpan',
            description:
          ...
          },
          {
            name: 'title',
            description:
              'any - Part of PanelHead component. Specifies the title of the panel.',
          },
          {
            name: 'description',
            description:
              'any - Part of PanelHead component. Specifies the description of the panel.',
          },
        ]}
        type="Inputs"
      />
      ...
      <Properties
        properties={[
          { name: 'PanelBody', description: 'The panel body.' },
          {
            name: 'PanelHeader',
            description:
              'The panel header. Contains a panel head and panel actions.',
          },
          {
            name: 'PanelHead',
            description:
              'Part of the header. Contains the title and description of the panel.',
          },
          {
            name: 'PanelActions',
            description:
