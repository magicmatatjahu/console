...
export const ListGroupComponent = () => {
  ...
  return (
    <div>
      ...
      <Description>
        Lists and tables are similar as both usually contain a vertical list of
        data, but lists generally contain basic data and tables tend to hold
        more complex data. If the list is a complex hierarchy, it is best to use
        a tree.
      </Description>
      ...
      <Properties
        properties={[
          {
            name: 'labelProps',
            description: 'object - additional props to be spread to the label',
          },
          {
            name: 'inputProps',
            description:
      ...
      <h2>Simple List</h2>
      <Description>
        A link can be used to allow the user to access more details about the
        item.
      </Description>
      <DocsTile>
        <ListGroup>
      ...
      <Description>
        Checkboxes can be include on the left of each line for such purposes as
        bulk actions.
      </Description>
      <DocsTile>
        <ListGroup>
          ...
          <ListGroupItem>
            <ListGroupItemCheckbox>List item 2</ListGroupItemCheckbox>
          </ListGroupItem>
          <ListGroupItem>
            <ListGroupItemCheckbox>List item 3</ListGroupItemCheckbox>
          </ListGroupItem>
          <ListGroupItem>
            <ListGroupItemCheckbox>List item 4</ListGroupItemCheckbox>
          </ListGroupItem>
        </ListGroup>
      </DocsTile>
