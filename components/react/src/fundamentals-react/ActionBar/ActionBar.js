    ...
    <React.Fragment>
      {mobile ? (
        <div style={{ width: width ? width : '319px' }}>
          <div {...props} className={actionBarClasses}>
            {children}
          </div>
        </div>
      ) : (
...
export const ActionBarHeader = ({
  ...
  return (
    <div {...props} className={actionBarHeaderClasses}>
      <h1 {...titleProps} className="fd-action-bar__title">
        {title}
      </h1>
      <p {...descriptionProps} className="fd-action-bar__description">
        {description}{' '}
      </p>
    </div>
  );
...
export const ActionBarActions = ({ children, className, ...props }) => {
  ...
  return (
    <div {...props} className={actionBarActionsClasses}>
      {children}
    </div>
  );
};
