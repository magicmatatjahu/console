...
/>`;
  ...
  return (
    <div>
      <Header>Table</Header>
      <Description>
        A table is a set tabular data. Line items can support data, images and
        actions.
      </Description>
      ...
      <Properties
        properties={[
          ...
          },
          {
            ...
            description:
              'object - additional props to be spread to the thead element.',
          },
          {
            name: 'tableHeaderRowProps',
            description:
              'object - additional props to be spread to the tr element in the thead.',
          },
          {
            name: 'tableBodyProps',
            description:
              'object - additional props to be spread to the tbody element.',
          },
          {
            name: 'tableBodyRowProps',
            description:
              'object or function - additional props to be spread to the tr elements in the tbody. If using a function, the parameters passed will be an object representing the row (from tableData) and the row index.',
          },
        ]}
        type="Inputs"
      />
      ...
      <h2>Simple Table</h2>
      <Description>
        This is an example of a table with simple cells, where the rowData is an
        array of strings.
      </Description>
      <br />
      <br />
      ...
      <h2>Rich Table</h2>
      <Description>
        This is an example of a table with rich cells. The checkbox input can be
        used at the beginning of each row to allow for bulk actions.When more
        than three actions exist per row and/or space doesn’t allow for actions,
        a contextual menu can be substituted in order to display all actions in
        one menu.
      </Description>
      <DocsTile>
        <Table
