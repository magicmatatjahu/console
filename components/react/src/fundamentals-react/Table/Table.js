...
export const Table = props => {
  ...
  const tableClasses = classnames('fd-table', className);
      ...
      <tbody {...tableBodyProps}>
        {tableData.map((row, index) => {
          ...
          if (tableBodyRowProps) {
            rowProps =
              typeof tableBodyRowProps === 'function'
...
Table.propTypes = {
  ...
  tableBodyRowProps: PropTypes.oneOfType([PropTypes.object, PropTypes.func]),
