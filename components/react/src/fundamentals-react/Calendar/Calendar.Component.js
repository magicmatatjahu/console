...
export const CalendarComponent = () => {
  ...
  const calendarDisabledWeekendsBeforeDate =
    '<Calendar disableBeforeDate={new Date(2018,7,3,0,0,0,0)} disableWeekends={true}/>';
  const calendarDisabledWeekdaysBlockedDates =
  ...
  return (
    <div>
      ...
      <Properties
        properties={[
          { name: 'disableWeekends', description: 'bool - Disable weekends' },
          {
            ...
            description:
              'date - Disables dates of a calendar that comes before a specific date',
          },
          {
            name: 'disableAfterDate',
            description:
              'date - Disables dates of a calendar that comes after a specific date',
          },
          {
            name: 'disableWeekday',
            description:
              'array of strings - Disables dates of a calendar that match a weekday',
          },
          {
            name: 'disablePastDates',
            description: 'bool - Disables dates that comes before today date',
          },
          {
            name: 'disableFutureDates',
            description:
              'bool - Disables dates that comes after the today date',
          },
          {
            name: 'blockedDates',
            description:
              'array of dates - Blocks dates that are between in the blocked dates',
          },
          {
            name: 'disabledDates',
            description:
              'array of dates - Disables dates that are between in the disabled dates',
          },
          {
            name: 'enableRangeSelection',
            description: 'bool - Enable to select two dates',
          },
          {
            name: 'monthListProps',
            description: 'object - Props to be spread to month <ul>',
          },
          {
            name: 'tableBodyProps',
            description: 'object - Props to be spread to <tbody>',
          },
          {
            name: 'tableHeaderProps',
            description: 'object - Props to be spread to <thead>',
          },
          {
            name: 'tableProps',
            description: 'object - Props to be spread to month <table>',
          },
          {
            name: 'yearListProps',
            description: 'object - Props to be spread to year <ul>',
          },
        ]}
        type="Inputs"
      />
      ...
      <DocsTile centered>{<Calendar enableRangeSelection />}</DocsTile>
