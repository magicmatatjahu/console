      ...
      <Popover
        ...
        body={
          <nav className="fd-menu">
            <ul
              {...listProps}
              className="fd-menu__list fd-localization-editor__list"
            >
              {menu.map((item, index) => {
                let { inputProps, language, placeholder, ...itemProps } = item;

                return (
                  <li {...itemProps} key={index}>
                    <div className={localizationEditorCompactClasses}>
                      {textarea ? (
                        <textarea {...inputProps} />
                      ) : (
                        <input
                      ...
                      <span className={localizationEditorAddonClasses}>
                        {language}
                      </span>
                    </div>
                  </li>
        ...
        control={
          <div>
            ...
            <div className={localizationEditorCompactClasses}>
              ...
              <span className={localizationEditorTextareaClasses}>
                <button
                  {...control.buttonProps}
