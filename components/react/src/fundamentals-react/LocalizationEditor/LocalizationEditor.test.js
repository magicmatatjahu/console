...
describe('<LocalizationEditor />', () => {
  ...
  describe('Prop spreading', () => {
    ...
    test("should allow props to be spread to the LocalizationEditor component's Popover component", () => {
      ...
      expect(
        element.find('.fd-popover').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the LocalizationEditor component's control textarea element", () => {
      ...
      expect(
        element.find('#controlTextArea').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the LocalizationEditor component's control input element", () => {
      ...
      const element = mount(
        <LocalizationEditor control={control} menu={defaultMenuArray} />,
      );

      expect(
        element.find('#controlInput').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the LocalizationEditor component's control button element", () => {
      ...
      expect(
        element.find('#controlButton').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the LocalizationEditor component's body list li elements", () => {
      ...
      const element = mount(
        <LocalizationEditor control={defaultControl} menu={menu} />,
      );

      const listItems = element.find('nav > ul > li');

      expect(listItems).toHaveLength(3);
      expect(listItems.at(0).getDOMNode().attributes['data-sample'].value).toBe(
        'Sample 1',
      );
      expect(listItems.at(1).getDOMNode().attributes['data-sample'].value).toBe(
        'Sample 2',
      );
      expect(listItems.at(2).getDOMNode().attributes['data-sample'].value).toBe(
        'Sample 3',
      );
    });
      ...
      const menu = [
        {
          placeholder: 'Enter Label',
          language: 'ES',
          inputProps: { 'data-sample': 'Sample 1' },
        },
        {
          placeholder: 'Enter Label',
          language: 'CH',
          inputProps: { 'data-sample': 'Sample 2' },
        },
        {
          placeholder: 'Enter Label',
          language: 'PL',
          inputProps: { 'data-sample': 'Sample 3' },
        },
      ];
      const element = mount(
        <LocalizationEditor control={defaultControl} menu={menu} textarea />,
      );
