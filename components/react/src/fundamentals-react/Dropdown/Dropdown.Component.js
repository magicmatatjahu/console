...
<Dropdown standard>
  ...
  return (
    <div>
      ...
      <Description>
        The dropdown component let the user select one of different options. It
        is more flexible than the normal Select.
      </Description>
        ...
        properties={[
          {
            name: 'standard',
            description:
              "bool - set to 'true' to enable a dropdown for toolbar.",
          },
        ]}
        type="Inputs"
      />
