        ...
        properties={[
          {
            name: 'size',
            description:
              'string - These sizes are available: xxs (extra extra small) - 20px, xs (extra small) - 28px, s (small) - 32px, m (medium) - 48px, l (large) - 64px, xl (extra lagre) - 88px, and xxl (extra extra large). Default matches the base font size (14px).',
          },
          {
            name: 'glyph',
            description:
          ...
          {
            name: 'modifier',
            description: "string - Can be 'circle' or 'transparent'.",
          },
          {
            name: 'color',
            description:
