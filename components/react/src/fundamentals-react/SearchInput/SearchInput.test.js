...
describe('<SearchInput />', () => {
  ...
  describe('Prop spreading', () => {
    ...
    test("should allow props to be spread to the SearchInput component's input element", () => {
      let element = mount(
        <SearchInput inputProps={{ 'data-sample': 'Sample' }} />,
      );
      ...
      element = mount(
        <SearchInput inShellbar inputProps={{ 'data-sample': 'Sample1' }} />,
      );
    ...
    test("should allow props to be spread to the SearchInput component's button element", () => {
      let element = mount(
        <SearchInput searchBtnProps={{ 'data-sample': 'Sample' }} />,
      );
      ...
      element = mount(
        <SearchInput
          inShellbar
          searchBtnProps={{ 'data-sample': 'Sample1' }}
        />,
      );
