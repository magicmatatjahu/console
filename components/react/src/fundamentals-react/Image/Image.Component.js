...
<Image size="l" type="circle" photo="https://placeimg.com/400/400/nature"></Image>`;
  return (
    <div>
      <Header>Image</Header>
      <Description>
        When using images, use the following helpers classes to adjust the size
        and the shape.
      </Description>
      ...
      <Properties
        properties={[
          ...
          {
            name: 'type',
            description: "string - When set to 'circle' renders a round image.",
          },
        ]}
        type="Inputs"
      />
      ...
      >
        <Image photo="https://placeimg.com/400/400/nature" size="s" type="" />
      </Playground>
    </div>
  );
};
