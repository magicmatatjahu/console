...
describe('<InputGroup />', () => {
  ...
  describe('Prop spreading', () => {
    ...
    test("should allow props to be spread to the InputGroup component's (type text, addonPos after) input element", () => {
      const element = mount(
        <InputGroup inputProps={{ 'data-sample': 'Sample' }} />,
      );
    ...
    test('should allow props to be spread to the InputGroup component for addonPos before (type text)', () => {
      const element = mount(
        <InputGroup addonPos="before" data-sample="Sample" />,
      );
    ...
    test('should allow props to be spread to the InputGroup component for type number', () => {
      const element = mount(
        <InputGroup data-sample="Sample" inputType="number" />,
      );
    ...
    test("should allow props to be spread to the InputGroup component for type number's up button element", () => {
      const element = mount(
        <InputGroup
          inputType="number"
          numberUpButtonProps={{ 'data-sample': 'Sample' }}
        />,
      );

      expect(
        element.find('button.sap-icon--slim-arrow-up').getDOMNode().attributes[
          'data-sample'
        ].value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the InputGroup component for type number's down button element", () => {
      const element = mount(
        <InputGroup
          inputType="number"
          numberDownButtonProps={{ 'data-sample': 'Sample' }}
        />,
      );

      expect(
        element.find('button.sap-icon--slim-arrow-down').getDOMNode()
    ...
    test('should allow props to be spread to the InputGroup component for type search', () => {
      const element = mount(
        <InputGroup data-sample="Sample" inputType="search" />,
      );
    ...
    test("should allow props to be spread to the InputGroup component for type search's button element", () => {
      const element = mount(
        <InputGroup
          inputType="search"
          searchButtonProps={{ 'data-sample': 'Sample' }}
        />,
      );
