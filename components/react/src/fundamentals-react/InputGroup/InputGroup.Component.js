    ...
    <div>
      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'inputProps',
            description:
              'object - additional props to be spread to the input element.',
          },
          {
            name: 'numberUpButtonProps',
            description:
              "object - additional props to be spread to the up button element (for inputType='number').",
          },
          {
            name: 'numberDownButtonProps',
            description:
              "object - additional props to be spread to the down button element (for inputType='number').",
          },
          {
            name: 'searchButtonProps',
            description:
              "object - additional props to be spread to the button element (for inputType='search').",
          },
        ]}
        type="Inputs"
      />
      ...
      <DocsTile>
        ...
        <FormGroup>
          <FormLabel labelText="Input with icon text action" />
          <FormItem>
            <InputGroup actions addonPos="after" inputType="text">
        ...
        <FormGroup>
          <FormLabel labelText="Input with icon text action" />
          <FormItem>
            <InputGroup actions addonPos="after" compact inputType="text">
              <Button glyph="navigation-down-arrow" option="light" />
            </InputGroup>
          </FormItem>
        </FormGroup>
