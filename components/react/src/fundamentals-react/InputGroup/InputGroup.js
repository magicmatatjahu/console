...
export const FormGroup = ({ children, ...props }) => {
  return (
    <div {...props} className="fd-form__group">
      {children}
    </div>
  );
};
  ...
  render() {
    ...
    switch (inputType) {
      case 'number':
        ...
        return (
          <div {...props} className={inputGroupNumberClasses}>
            <input
              {...inputProps}
      ...
      case 'search':
        const inputGroupSearchClasses = classnames('fd-input-group', {
          'fd-input-group--compact': compact,
        });
        ...
        return (
          <div {...props} className={inputGroupSearchClasses}>
            <input
              {...inputProps}
      ...
      default: {
        if (addonPos === 'before') {
          ...
          return (
            <div {...props} className={inputGroupBeforeClasses}>
              {actions ? (
          ...
          return (
            <div {...props} className={inputGroupAfterClasses}>
              <input
                {...inputProps}
