...
describe('<Menu />', () => {
    ...
    <MemoryRouter>
      <Menu className="blue">
        <MenuList className="blue">
          ...
          <MenuItem className="blue" isLink link="/">
            Option 2
          </MenuItem>
  ...
  describe('Prop spreading', () => {
    ...
    test("should allow props to be spread to the MenuItem component's addon div element", () => {
      ...
      expect(
        element.find('div.fd-menu__addon-before').getDOMNode().attributes[
          'data-sample'
        ].value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the MenuItem component's Link component", () => {
      ...
      expect(
        element.find('a.fd-menu__item').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test('should allow props to be spread to the MenuGroup h1 component', () => {
      const element = mount(
        <MenuGroup titleProps={{ 'data-sample': 'Sample' }} />,
      );
