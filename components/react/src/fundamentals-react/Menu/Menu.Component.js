...
export const MenuComponent = () => {
  ...
  return (
    <div>
      <Header>Menu</Header>
      <Description>
        The menu component is the listing structure with optional headers to
        create menus. Commonly used as the contents when composing “dropdowns”,
        “contextual menus”, “mega menu”, etc, when paired with the popover
        component.
      </Description>
        ...
        properties={[
          {
            name: 'addonBefore',
            description:
              'bool - when set to true, enables menu items with addon before.',
          },
        ]}
        type="Inputs"
      />
        ...
        properties={[
          {
            name: 'addon',
            description:
              'string - the name of the SAP icon to be applied as an addon before.',
          },
          {
            name: 'addonProps',
            description:
              'object - additional props to be spread to the addon section',
          },
          {
            name: 'link',
            description: "string - a router link. Use either 'url' or 'link'",
          },
          {
            name: 'linkProps',
            description:
              'object - additional props to be spread to the Menu Item links',
          },
          {
            name: 'separator',
            description:
              'bool - when set to true, adds a horizontal line (separator).',
          },
          {
            name: 'url',
            description:
              "string - href attribute of <a> tag. Use either 'url' or 'link'",
          },
          {
            name: 'urlProps',
            description:
              'object - additional props to be spread to the Menu Item Url links',
          },
        ]}
      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'titleProps',
            description:
              'object - additional props to be spread to the Menu Group title',
          },
        ]}
