...
export const Tabs = props => {
  ...
  const tabClasses = classnames('fd-tabs-container', className);
...
export class TabComponent extends Component {
  ...
  getLinkClasses = id => {
    return classnames('fd-tabs__link', {
  ...
  render() {
    ...
    const tabClasses = classnames('fd-tabs', className);
    ...
    return (
      <BrowserRouter>
        <ul {...rest} className={tabClasses}>
          {ids.map(id => {
            return (
              <li {...tabProps} className="fd-tabs__item" key={id.id}>
                <Link
                  {...tabLinkProps}
                ...
                {this.state.selectedTab === id.id ? (
                  <p {...tabContentProps} className="fd-tabs__content">
                    {id.content}
                  </p>
                ) : null}
              </li>
