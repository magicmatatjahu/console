...
describe('<Tabs />', () => {
  ...
  const tabComponent = <TabComponent ids={defaultIds} />;

  const tabComponentWithClass = (
    <TabComponent className="blue" ids={defaultIds} />
  );
  ...
  describe('Prop spreading', () => {
    ...
    test('should allow props to be spread to the TabComponent component', () => {
      const element = mount(
        <TabComponent data-sample="Sample" ids={defaultIds} />,
      );
    ...
    test("should allow props to be spread to the TabComponent component's content component", () => {
      const element = mount(
        <TabComponent
          ids={defaultIds}
          tabContentProps={{ 'data-sample': 'Sample' }}
        />,
      );
    ...
    test("should allow props to be spread to the TabComponent component's Link component", () => {
      const element = mount(
        <TabComponent
          ids={defaultIds}
          tabLinkProps={{ 'data-sample': 'Sample' }}
        />,
      );
