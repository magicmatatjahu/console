...
export const TabsComponent = () => {
  ...
  return (
    <div>
      <Header>Tabs</Header>
      <Description>
        Tabs are based on a folder metaphor and used to separate content into
        different sections. Tabs should be ordered to create a visual hierarchy
        based on priority.
      </Description>
      ...
      <Properties
        properties={[
          ...
          {
            name: 'content',
            description: 'the content to display when the tab is pressed',
          },
          {
            name: 'disabled',
            description: 'disable the tab based on true or false',
          },
        ]}
        type="Tab Inputs"
      />
      <Properties
        properties={[
          ...
          { name: 'className', description: 'string - class to add to tab' },
          {
            ...
            description:
              "object - additional props to be spread to the tab's content",
          },
          {
            name: 'tabLinkProps',
            description:
              "object - additional props to be spread to the tab's link",
          },
          {
            name: 'tabProps',
            description: 'object - additional props to be spread to the tab',
          },
        ]}
