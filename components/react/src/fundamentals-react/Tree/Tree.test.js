...
describe('<Tree />', () => {
  ...
  describe('Prop spreading', () => {
    test('should allow props to be spread to the Tree component', () => {
      const data = [];
      const element = mount(
        <Tree data-sample="Sample" headers={defaultHeaders} treeData={data} />,
      );
    ...
    test("should allow props to be spread to the Tree component's header element", () => {
      ...
      expect(
        element.find('.fd-tree--header').getDOMNode().attributes['data-sample']
          .value,
      ).toBe('Sample');
    });
    ...
    test("should allow props to be spread to the Tree component's header button elements", () => {
      ...
      expect(
        element.find('.fd-tree--header button').getDOMNode().attributes[
          'data-sample'
        ].value,
      ).toBe('Sample');
    });
