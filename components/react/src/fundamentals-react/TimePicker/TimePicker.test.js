...
describe('<TimePicker />', () => {
  ...
  const showHourMinute = (
    <TimePicker format12Hours={false} showHour={false} showMinute />
  );
  const showMinuteSecond = (
    <TimePicker format12Hours showHour={false} showMinute showSecond />
  );
  const showHourSecond = (
    <TimePicker format12Hours showHour showMinute={false} showSecond />
  );
  ...
  test('changing a value', () => {
    ...
    wrapper = mount(
      <TimePicker format12Hours={false} showHour showMinute showSecond />,
    );
    wrapper
      .find('input[type="text"]')
      .at(0)
    ...
    wrapper = mount(
      <TimePicker format12Hours showHour showMinute showSecond={false} />,
    );
    wrapper
      .find('input[type="text"]')
      .at(0)
  ...
  test('check value change', () => {
    ...
    // just minute and second, no 12 hr format
    let wrapper = mount(
      <TimePicker format12Hours showHour showMinute showSecond />,
    );
  ...
  describe('Prop spreading', () => {
    ...
    test("should allow props to be spread to the TimePicker component's TimePickerItem component's input element", () => {
      const element = mount(
        <TimePicker id="id" inputProps={{ 'data-sample': 'Sample' }} />,
      );
    ...
    test("should allow props to be spread to the TimePicker component's TimePickerItem component's button element", () => {
      const element = mount(
        <TimePicker buttonProps={{ 'data-sample': 'Sample' }} id="id" />,
      );
    ...
    test("should allow props to be spread to the TimePicker component's Time component", () => {
      const element = mount(
        <TimePicker id="id" timeProps={{ 'data-sample': 'Sample' }} />,
      );
