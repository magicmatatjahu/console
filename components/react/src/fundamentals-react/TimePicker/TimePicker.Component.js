      ...
      <Properties
        properties={[
          ...
          },
          {
            name: 'buttonProps',
            description:
              "object - Additional props to be spread to the TimePicker component's button element.",
          },
          {
            name: 'inputProps',
            description:
              "object - Additional props to be spread to the TimePicker component's input element.",
          },
          {
            name: 'timeProps',
            description:
              "object - Additional props to be spread to the TimePicker component's Time component.",
          },
        ]}
        type="Inputs"
      />
