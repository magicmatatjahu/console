...
export const TileContent = props => {
  ...
  const tileContentClasses = classnames('fd-tile__content', className);

  return (
    <div {...rest} className={tileContentClasses}>
      <h2 {...titleProps} className="fd-tile__title">
        {title}
      </h2>
      {children}
    </div>
...
export const TileMedia = props => {
  ...
  const tileMediaClasses = classnames('fd-tile__media', className);
...
export const TileActions = props => {
  ...
  const tileActionsClasses = classnames('fd-tile__actions', className);

  return (
    <div {...rest} className={tileActionsClasses}>
      {children}
    </div>
  );
};
...
export const ProductTile = props => {
  ...
  return (
    <div {...rest} className={tileProductClasses}>
      {children}
    </div>
  );
};
...
export const ProductTileContent = props => {
  ...
  return (
    <div {...rest} className={tileProductContentClasses}>
      <h2 {...titleProps} className="fd-product-tile__title">
        {title}
      </h2>
      {children}
    </div>
...
export const TileGrid = props => {
  ...
  return (
    <div {...rest} className={tileGridClasses}>
      {children}
    </div>
  );
};
