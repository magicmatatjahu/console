        ...
        properties={[
          {
            name: 'text',
            description:
              'string (required) - The text to display in the inline help pop-up.',
          },
          {
            name: 'placement',
            description:
