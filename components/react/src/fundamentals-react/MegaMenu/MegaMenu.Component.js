...
export const MegaMenuComponent = () => {
  ...
  return (
    <div>
      ...
      <Description>
        Mega menu is used in conjunction with Context Switcher within the Global
        Navigation (link to Global Nav page) and supports two levels within a
        hierarchy.
      </Description>
        ...
        properties={[
          {
            name: 'items',
            description:
              "array - an array of objects with keys 'id', 'url' or 'link', 'name', 'hasChild', and 'child' setting the attributes of the items.",
          },
          ...
          },
          {
            name: 'child',
            description:
              "array - an array of objects with keys 'id', 'url' or 'link', and 'name' setting the attributes of the subitems.",
          },
          {
            name: 'headerProps',
            description:
              "object - additional props to be spread to the MegaMenuGroup's <h1> element",
          },
        ]}
        type="Inputs"
      />
