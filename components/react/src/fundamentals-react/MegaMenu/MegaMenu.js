...
export const MegaMenu = ({ children, className, ...props }) => {
  const megaMenuClasses = classnames('fd-mega-menu', className);

  return (
    <nav {...props} className={megaMenuClasses}>
      {children}
    </nav>
  );
};
...
export class MegaMenuList extends Component {
  ...
  getLinkClasses = ({ id, hasChild }) => {
    return classnames('fd-mega-menu__link', {
  ...
  getSubLinkClasses = ({ id }) => {
    return classnames('fd-mega-menu__sublink', {
      'is-selected': this.state.selectedItem === id,
    });
  };
  ...
  render() {
    ...
    const megaMenuListClasses = classnames('fd-mega-menu__list', className);
...
export const MegaMenuGroup = ({
  ...
  const megaMenuGroupClasses = classnames('fd-mega-menu__group', className);

  return (
    <div {...props} className={megaMenuGroupClasses}>
      <h1 {...headerProps} className="fd-mega-menu__title">
        {title}
      </h1>
      {children}
    </div>
