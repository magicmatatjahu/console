...
describe('<Forms />', () => {
  const formInput = (
    <FormSet>
      ...
      <FormItem>
        ...
        <FormSelect className="blue" disabled id="select-1">
          <option value="1">Duis malesuada odio volutpat elementum</option>
        </FormSelect>
      </FormItem>
    </FormSet>
  ...
  const formRadio = <FormRadio defaultChecked="radio-2" inputs={radioInputs} />;
  ...
  describe('Prop spreading', () => {
    ...
    xtest('should allow props to be spread to the FormRadio component', () => {
      ...
      const element = mount(
        <FormRadio data-sample="Sample" inputs={radioInputs} />,
      );
