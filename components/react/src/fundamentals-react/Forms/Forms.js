...
export const FormSet = ({ children, className, ...props }) => {
  const formSetClasses = classnames('fd-form__set', className);
...
export const FormItem = ({
  ...
  return (
    <div {...props} className={formItemClasses}>
      {children}
    </div>
  );
};
...
export const FormLabel = ({ required, children, className, ...props }) => {
  const formLabelClasses = classnames('fd-form__label', className);
  return (
    <label {...props} aria-required={required} className={formLabelClasses}>
      {children}
      {required ? '*' : ''}
    </label>
  );
...
export const FormMessage = ({ type, children, className, ...props }) => {
  ...
  return (
    <span {...props} className={formMessageClasses}>
      {children}
    </span>
  );
};
...
export const FormInput = ({ state, className, ...props }) => {
  ...
  return <input {...props} className={formInputClasses} />;
};
FormInput.propTypes = {
  className: PropTypes.string,
...
export const FormTextarea = ({ children, className, ...props }) => {
  const formTextAreaClasses = classnames('fd-form__control', className);

  return (
    <textarea {...props} className={formTextAreaClasses}>
      {children}
    </textarea>
  );
};
...
export const FormFieldset = ({ children, className, ...props }) => {
  const formFieldsetClasses = classnames('fd-form__set', className);

  return (
    <fieldset {...props} className={formFieldsetClasses}>
      {children}
    </fieldset>
  );
};
...
export const FormLegend = ({ children, className, ...props }) => {
  const formLegendClasses = classnames('fd-form__legend', className);

  return (
    <legend {...props} className={formLegendClasses}>
      {children}
    </legend>
  );
};
...
export const FormSelect = ({ disabled, children, className, ...props }) => {
  const formSelectClasses = classnames('fd-form__control', className);
