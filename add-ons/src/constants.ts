export const DEFAULT_CONFIGURATION = (window as any)["clusterConfig"].DEFAULT_CONFIGURATION || "helm-repos-urls";
export const DEFAULT_CONFIGURATION_DESCRIPTION = "";
export const HELM_BROKER_IS_DEVELOPMENT_MODE = (window as any)["clusterConfig"].HELM_BROKER_IS_DEVELOPMENT_MODE || true;
